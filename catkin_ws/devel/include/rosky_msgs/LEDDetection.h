// Generated by gencpp from file rosky_msgs/LEDDetection.msg
// DO NOT EDIT!


#ifndef ROSKY_MSGS_MESSAGE_LEDDETECTION_H
#define ROSKY_MSGS_MESSAGE_LEDDETECTION_H
...
struct LEDDetection_
{
  ...
  _timestamp2_type timestamp2;
   ...
   typedef  ::rosky_msgs::Vector2D_<ContainerAllocator>  _pixels_normalized_type;
  ...
  typedef boost::shared_ptr< ::rosky_msgs::LEDDetection_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosky_msgs::LEDDetection_<ContainerAllocator> const> ConstPtr;

}; // struct LEDDetection_

typedef ::rosky_msgs::LEDDetection_<std::allocator<void> > LEDDetection;

typedef boost::shared_ptr< ::rosky_msgs::LEDDetection > LEDDetectionPtr;
typedef boost::shared_ptr< ::rosky_msgs::LEDDetection const> LEDDetectionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosky_msgs::LEDDetection_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosky_msgs::LEDDetection_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::rosky_msgs::LEDDetection_<ContainerAllocator1> & lhs, const ::rosky_msgs::LEDDetection_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosky_msgs::LEDDetection_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosky_msgs::LEDDetection_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosky_msgs::LEDDetection_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosky_msgs::LEDDetection_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd1ac8691d7a30e83ULL;
  static const uint64_t static_value2 = 0x8dc372a724aee94bULL;
};

template<class ContainerAllocator>
struct DataType< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rosky_msgs::LEDDetection_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosky_msgs::LEDDetection_<ContainerAllocator>& v)
  {
    s << indent << "timestamp1: ";
    ...
    s << std::endl;
    Printer< ::rosky_msgs::Vector2D_<ContainerAllocator> >::stream(s, indent + "  ", v.pixels_normalized);
    s << indent << "frequency: ";
...
#endif // ROSKY_MSGS_MESSAGE_LEDDETECTION_H
