// Generated by gencpp from file rosky_msgs/SignalsDetection.msg
// DO NOT EDIT!


#ifndef ROSKY_MSGS_MESSAGE_SIGNALSDETECTION_H
#define ROSKY_MSGS_MESSAGE_SIGNALSDETECTION_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::rosky_msgs::SignalsDetection_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosky_msgs::SignalsDetection_<ContainerAllocator> const> ConstPtr;

}; // struct SignalsDetection_

typedef ::rosky_msgs::SignalsDetection_<std::allocator<void> > SignalsDetection;

typedef boost::shared_ptr< ::rosky_msgs::SignalsDetection > SignalsDetectionPtr;
typedef boost::shared_ptr< ::rosky_msgs::SignalsDetection const> SignalsDetectionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rosky_msgs::SignalsDetection_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::rosky_msgs::SignalsDetection_<ContainerAllocator1> & lhs, const ::rosky_msgs::SignalsDetection_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rosky_msgs::SignalsDetection_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rosky_msgs::SignalsDetection_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rosky_msgs::SignalsDetection_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rosky_msgs::SignalsDetection_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x30bdaa5e0b8f4e5aULL;
  static const uint64_t static_value2 = 0xabc36ddd53f7926aULL;
};

template<class ContainerAllocator>
struct DataType< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rosky_msgs::SignalsDetection_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosky_msgs::SignalsDetection_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ROSKY_MSGS_MESSAGE_SIGNALSDETECTION_H
