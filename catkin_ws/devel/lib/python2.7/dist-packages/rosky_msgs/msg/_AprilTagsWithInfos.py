...
"""autogenerated by genpy from rosky_msgs/AprilTagsWithInfos.msg. Do not edit."""
import sys
...
class AprilTagsWithInfos(genpy.Message):
  ...
  _type = "rosky_msgs/AprilTagsWithInfos"
...
"""
  ...
  _slot_types = ['std_msgs/Header','rosky_msgs/AprilTagDetection[]','rosky_msgs/TagInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rosky_msgs.msg.AprilTagDetection()
        _x = val1
        start = end
        end += 12
