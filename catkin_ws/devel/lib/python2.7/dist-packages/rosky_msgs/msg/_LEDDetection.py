...
"""autogenerated by genpy from rosky_msgs/LEDDetection.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['time','time','rosky_msgs/Vector2D','float32','string','float32','float64[]','float32[]','float32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pixels_normalized is None:
        self.pixels_normalized = rosky_msgs.msg.Vector2D()
