...
"""autogenerated by genpy from rosky_msgs/LEDDetectionDebugInfo.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import rosky_msgs.msg
import std_msgs.msg
import genpy
...
class LEDDetectionDebugInfo(genpy.Message):
  ...
  _type = "rosky_msgs/LEDDetectionDebugInfo"
...
"""
  ...
  _slot_types = ['uint8','float32','uint32[2]','float32[4]','sensor_msgs/CompressedImage','rosky_msgs/Vector2D[]','rosky_msgs/LEDDetectionArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.led_all_unfiltered is None:
        self.led_all_unfiltered = rosky_msgs.msg.LEDDetectionArray()
    else:
      self.state = 0
      self.capture_progress = 0.
      self.cell_size = [0] * 2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rosky_msgs.msg.LEDDetection()
        _v4 = val1.timestamp1
        _x = _v4
        start = end
        end += 8
