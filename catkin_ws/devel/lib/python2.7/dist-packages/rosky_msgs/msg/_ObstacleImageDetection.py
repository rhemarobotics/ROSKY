...
"""autogenerated by genpy from rosky_msgs/ObstacleImageDetection.msg. Do not edit."""
import sys
...
class ObstacleImageDetection(genpy.Message):
  ...
  _type = "rosky_msgs/ObstacleImageDetection"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """rosky_msgs/Rect bounding_box
...
uint8 type"""
  ...
  _slot_types = ['rosky_msgs/Rect','rosky_msgs/ObstacleType']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_box is None:
        self.bounding_box = rosky_msgs.msg.Rect()
      if self.type is None:
        self.type = rosky_msgs.msg.ObstacleType()
    else:
      self.bounding_box = rosky_msgs.msg.Rect()
      self.type = rosky_msgs.msg.ObstacleType()
