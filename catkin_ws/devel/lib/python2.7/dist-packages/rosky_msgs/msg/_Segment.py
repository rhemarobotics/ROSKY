...
"""autogenerated by genpy from rosky_msgs/Segment.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['uint8','rosky_msgs/Vector2D[2]','rosky_msgs/Vector2D','geometry_msgs/Point[2]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pixels_normalized is None:
        self.pixels_normalized = [rosky_msgs.msg.Vector2D() for _ in range(2)]
      if self.normal is None:
        self.normal = rosky_msgs.msg.Vector2D()
