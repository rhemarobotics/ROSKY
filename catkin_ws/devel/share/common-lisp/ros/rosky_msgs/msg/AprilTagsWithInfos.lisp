...
(cl:defclass <AprilTagsWithInfos> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector rosky_msgs-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:AprilTagDetection :initial-element (cl:make-instance 'rosky_msgs-msg:AprilTagDetection)))
   (infos
    :reader infos
    :initarg :infos
    :type (cl:vector rosky_msgs-msg:TagInfo)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:TagInfo :initial-element (cl:make-instance 'rosky_msgs-msg:TagInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagsWithInfos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagsWithInfos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<AprilTagsWithInfos> is deprecated: use rosky_msgs-msg:AprilTagsWithInfos instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AprilTagsWithInfos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:header-val is deprecated.  Use rosky_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <AprilTagsWithInfos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:detections-val is deprecated.  Use rosky_msgs-msg:detections instead.")
  (detections m))

(cl:ensure-generic-function 'infos-val :lambda-list '(m))
(cl:defmethod infos-val ((m <AprilTagsWithInfos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:infos-val is deprecated.  Use rosky_msgs-msg:infos instead.")
  (infos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagsWithInfos>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:AprilTagDetection))
  ...
  (cl:let ((vals (cl:slot-value msg 'infos)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:TagInfo))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
