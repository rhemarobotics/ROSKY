...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<BoolStamped> is deprecated: use rosky_msgs-msg:BoolStamped instead.")))
...
(cl:defmethod data-val ((m <BoolStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:data-val is deprecated.  Use rosky_msgs-msg:data instead.")
  (data m))
