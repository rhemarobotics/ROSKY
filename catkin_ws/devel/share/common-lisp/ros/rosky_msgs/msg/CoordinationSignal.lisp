...
(cl:defmethod cl:initialize-instance :after ((m <CoordinationSignal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CoordinationSignal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<CoordinationSignal> is deprecated: use rosky_msgs-msg:CoordinationSignal instead.")))
