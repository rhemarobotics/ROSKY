...
(cl:defmethod cl:initialize-instance :after ((m <DuckieSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DuckieSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<DuckieSensor> is deprecated: use rosky_msgs-msg:DuckieSensor instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <DuckieSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:value-val is deprecated.  Use rosky_msgs-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'fvalue-val :lambda-list '(m))
(cl:defmethod fvalue-val ((m <DuckieSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:fvalue-val is deprecated.  Use rosky_msgs-msg:fvalue instead.")
  (fvalue m))

(cl:ensure-generic-function 'is_analog-val :lambda-list '(m))
(cl:defmethod is_analog-val ((m <DuckieSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:is_analog-val is deprecated.  Use rosky_msgs-msg:is_analog instead.")
  (is_analog m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <DuckieSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:name-val is deprecated.  Use rosky_msgs-msg:name instead.")
  (name m))
