...
(cl:defmethod cl:initialize-instance :after ((m <KinematicsWeights>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KinematicsWeights)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<KinematicsWeights> is deprecated: use rosky_msgs-msg:KinematicsWeights instead.")))

(cl:ensure-generic-function 'weights-val :lambda-list '(m))
(cl:defmethod weights-val ((m <KinematicsWeights>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:weights-val is deprecated.  Use rosky_msgs-msg:weights instead.")
  (weights m))
