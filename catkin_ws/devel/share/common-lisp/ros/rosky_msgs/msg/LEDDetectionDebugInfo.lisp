...
(cl:defclass <LEDDetectionDebugInfo> (roslisp-msg-protocol:ros-message)
  ((state
   ...
   (candidates
    :reader candidates
    :initarg :candidates
    :type (cl:vector rosky_msgs-msg:Vector2D)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:Vector2D :initial-element (cl:make-instance 'rosky_msgs-msg:Vector2D)))
   (led_all_unfiltered
    :reader led_all_unfiltered
    :initarg :led_all_unfiltered
    :type rosky_msgs-msg:LEDDetectionArray
    :initform (cl:make-instance 'rosky_msgs-msg:LEDDetectionArray)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LEDDetectionDebugInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LEDDetectionDebugInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<LEDDetectionDebugInfo> is deprecated: use rosky_msgs-msg:LEDDetectionDebugInfo instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:state-val is deprecated.  Use rosky_msgs-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'capture_progress-val :lambda-list '(m))
(cl:defmethod capture_progress-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:capture_progress-val is deprecated.  Use rosky_msgs-msg:capture_progress instead.")
  (capture_progress m))

(cl:ensure-generic-function 'cell_size-val :lambda-list '(m))
(cl:defmethod cell_size-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:cell_size-val is deprecated.  Use rosky_msgs-msg:cell_size instead.")
  (cell_size m))

(cl:ensure-generic-function 'crop_rect_norm-val :lambda-list '(m))
(cl:defmethod crop_rect_norm-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:crop_rect_norm-val is deprecated.  Use rosky_msgs-msg:crop_rect_norm instead.")
  (crop_rect_norm m))

(cl:ensure-generic-function 'variance_map-val :lambda-list '(m))
(cl:defmethod variance_map-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:variance_map-val is deprecated.  Use rosky_msgs-msg:variance_map instead.")
  (variance_map m))

(cl:ensure-generic-function 'candidates-val :lambda-list '(m))
(cl:defmethod candidates-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:candidates-val is deprecated.  Use rosky_msgs-msg:candidates instead.")
  (candidates m))
...
(cl:defmethod led_all_unfiltered-val ((m <LEDDetectionDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:led_all_unfiltered-val is deprecated.  Use rosky_msgs-msg:led_all_unfiltered instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LEDDetectionDebugInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'candidates)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:Vector2D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LEDDetectionDebugInfo>)))
  ...
  "rosky_msgs/LEDDetectionDebugInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LEDDetectionDebugInfo)))
  "Returns string type for a message object of type 'LEDDetectionDebugInfo"
  "rosky_msgs/LEDDetectionDebugInfo")
