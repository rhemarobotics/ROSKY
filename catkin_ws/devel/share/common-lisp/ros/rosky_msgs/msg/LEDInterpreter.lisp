...
(cl:defmethod cl:initialize-instance :after ((m <LEDInterpreter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LEDInterpreter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<LEDInterpreter> is deprecated: use rosky_msgs-msg:LEDInterpreter instead.")))
...
(cl:defmethod vehicle-val ((m <LEDInterpreter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:vehicle-val is deprecated.  Use rosky_msgs-msg:vehicle instead.")
  (vehicle m))

(cl:ensure-generic-function 'trafficlight-val :lambda-list '(m))
(cl:defmethod trafficlight-val ((m <LEDInterpreter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:trafficlight-val is deprecated.  Use rosky_msgs-msg:trafficlight instead.")
  (trafficlight m))
