...
(cl:defmethod cl:initialize-instance :after ((m <LanePose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LanePose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<LanePose> is deprecated: use rosky_msgs-msg:LanePose instead.")))
...
(cl:defmethod d-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:d-val is deprecated.  Use rosky_msgs-msg:d instead.")
  (d m))

(cl:ensure-generic-function 'sigma_d-val :lambda-list '(m))
(cl:defmethod sigma_d-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:sigma_d-val is deprecated.  Use rosky_msgs-msg:sigma_d instead.")
  (sigma_d m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:phi-val is deprecated.  Use rosky_msgs-msg:phi instead.")
  (phi m))

(cl:ensure-generic-function 'sigma_phi-val :lambda-list '(m))
(cl:defmethod sigma_phi-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:sigma_phi-val is deprecated.  Use rosky_msgs-msg:sigma_phi instead.")
  (sigma_phi m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:status-val is deprecated.  Use rosky_msgs-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'in_lane-val :lambda-list '(m))
(cl:defmethod in_lane-val ((m <LanePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:in_lane-val is deprecated.  Use rosky_msgs-msg:in_lane instead.")
  (in_lane m))
