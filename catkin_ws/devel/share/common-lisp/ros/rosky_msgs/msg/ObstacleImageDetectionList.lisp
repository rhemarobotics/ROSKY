...
(cl:defclass <ObstacleImageDetectionList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (list
    :reader list
    :initarg :list
    :type (cl:vector rosky_msgs-msg:ObstacleImageDetection)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:ObstacleImageDetection :initial-element (cl:make-instance 'rosky_msgs-msg:ObstacleImageDetection)))
   (imwidth
    :reader imwidth
    :initarg :imwidth
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleImageDetectionList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleImageDetectionList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<ObstacleImageDetectionList> is deprecated: use rosky_msgs-msg:ObstacleImageDetectionList instead.")))
...
(cl:defmethod list-val ((m <ObstacleImageDetectionList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:list-val is deprecated.  Use rosky_msgs-msg:list instead.")
  (list m))

(cl:ensure-generic-function 'imwidth-val :lambda-list '(m))
(cl:defmethod imwidth-val ((m <ObstacleImageDetectionList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:imwidth-val is deprecated.  Use rosky_msgs-msg:imwidth instead.")
  (imwidth m))

(cl:ensure-generic-function 'imheight-val :lambda-list '(m))
(cl:defmethod imheight-val ((m <ObstacleImageDetectionList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:imheight-val is deprecated.  Use rosky_msgs-msg:imheight instead.")
  (imheight m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstacleImageDetectionList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:ObstacleImageDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObstacleImageDetectionList>)))
  ...
  "rosky_msgs/ObstacleImageDetectionList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObstacleImageDetectionList)))
  "Returns string type for a message object of type 'ObstacleImageDetectionList"
  "rosky_msgs/ObstacleImageDetectionList")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstacleImageDetectionList>)))
  ...
  (cl:format cl:nil "Header header~%rosky_msgs/ObstacleImageDetection[] list~%float32 imwidth~%float32 imheight~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/ObstacleImageDetection~%rosky_msgs/Rect bounding_box~%rosky_msgs/ObstacleType type~%~%================================================================================~%MSG: rosky_msgs/Rect~%# all in pixel coordinate~%# (x, y, w, h) defines a rectangle~%int32 x~%int32 y~%int32 w~%int32 h~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstacleImageDetectionList)))
  "Returns full string definition for message of type 'ObstacleImageDetectionList"
  (cl:format cl:nil "Header header~%rosky_msgs/ObstacleImageDetection[] list~%float32 imwidth~%float32 imheight~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/ObstacleImageDetection~%rosky_msgs/Rect bounding_box~%rosky_msgs/ObstacleType type~%~%================================================================================~%MSG: rosky_msgs/Rect~%# all in pixel coordinate~%# (x, y, w, h) defines a rectangle~%int32 x~%int32 y~%int32 w~%int32 h~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
