...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleProjectedDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleProjectedDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<ObstacleProjectedDetection> is deprecated: use rosky_msgs-msg:ObstacleProjectedDetection instead.")))
...
(cl:defmethod distance-val ((m <ObstacleProjectedDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:distance-val is deprecated.  Use rosky_msgs-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObstacleProjectedDetection>)))
  ...
  "rosky_msgs/ObstacleProjectedDetection")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObstacleProjectedDetection)))
  "Returns string type for a message object of type 'ObstacleProjectedDetection"
  "rosky_msgs/ObstacleProjectedDetection")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstacleProjectedDetection>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point location~%rosky_msgs/ObstacleType type~%float32 distance~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstacleProjectedDetection)))
  "Returns full string definition for message of type 'ObstacleProjectedDetection"
  (cl:format cl:nil "geometry_msgs/Point location~%rosky_msgs/ObstacleType type~%float32 distance~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
