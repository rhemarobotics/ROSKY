...
(cl:defclass <ObstacleProjectedDetectionList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (list
    :reader list
    :initarg :list
    :type (cl:vector rosky_msgs-msg:ObstacleProjectedDetection)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:ObstacleProjectedDetection :initial-element (cl:make-instance 'rosky_msgs-msg:ObstacleProjectedDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleProjectedDetectionList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleProjectedDetectionList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<ObstacleProjectedDetectionList> is deprecated: use rosky_msgs-msg:ObstacleProjectedDetectionList instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstacleProjectedDetectionList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:ObstacleProjectedDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObstacleProjectedDetectionList>)))
  ...
  "rosky_msgs/ObstacleProjectedDetectionList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObstacleProjectedDetectionList)))
  "Returns string type for a message object of type 'ObstacleProjectedDetectionList"
  "rosky_msgs/ObstacleProjectedDetectionList")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstacleProjectedDetectionList>)))
  ...
  (cl:format cl:nil "Header header~%rosky_msgs/ObstacleProjectedDetection[] list~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/ObstacleProjectedDetection~%geometry_msgs/Point location~%rosky_msgs/ObstacleType type~%float32 distance~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstacleProjectedDetectionList)))
  "Returns full string definition for message of type 'ObstacleProjectedDetectionList"
  (cl:format cl:nil "Header header~%rosky_msgs/ObstacleProjectedDetection[] list~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/ObstacleProjectedDetection~%geometry_msgs/Point location~%rosky_msgs/ObstacleType type~%float32 distance~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: rosky_msgs/ObstacleType~%uint8 DUCKIE=0~%uint8 CONE=1~%uint8 type~%~%"))
