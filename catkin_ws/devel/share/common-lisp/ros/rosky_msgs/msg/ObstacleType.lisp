...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleType>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleType)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<ObstacleType> is deprecated: use rosky_msgs-msg:ObstacleType instead.")))
