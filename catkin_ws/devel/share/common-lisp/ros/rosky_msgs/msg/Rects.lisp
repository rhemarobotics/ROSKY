...
(cl:defmethod cl:initialize-instance :after ((m <Rects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<Rects> is deprecated: use rosky_msgs-msg:Rects instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Rects>)))
  ...
  (cl:format cl:nil "rosky_msgs/Rect[] rects~%~%================================================================================~%MSG: rosky_msgs/Rect~%# all in pixel coordinate~%# (x, y, w, h) defines a rectangle~%int32 x~%int32 y~%int32 w~%int32 h~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Rects)))
  "Returns full string definition for message of type 'Rects"
  (cl:format cl:nil "rosky_msgs/Rect[] rects~%~%================================================================================~%MSG: rosky_msgs/Rect~%# all in pixel coordinate~%# (x, y, w, h) defines a rectangle~%int32 x~%int32 y~%int32 w~%int32 h~%~%~%"))
