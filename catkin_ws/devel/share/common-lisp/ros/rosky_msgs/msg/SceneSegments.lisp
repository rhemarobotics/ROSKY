...
(cl:defclass <SceneSegments> (roslisp-msg-protocol:ros-message)
  ((segimage
   ...
   (rects
    :reader rects
    :initarg :rects
    :type (cl:vector rosky_msgs-msg:Rect)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:Rect :initial-element (cl:make-instance 'rosky_msgs-msg:Rect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SceneSegments>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SceneSegments)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<SceneSegments> is deprecated: use rosky_msgs-msg:SceneSegments instead.")))

(cl:ensure-generic-function 'segimage-val :lambda-list '(m))
(cl:defmethod segimage-val ((m <SceneSegments>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:segimage-val is deprecated.  Use rosky_msgs-msg:segimage instead.")
  (segimage m))

(cl:ensure-generic-function 'rects-val :lambda-list '(m))
(cl:defmethod rects-val ((m <SceneSegments>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:rects-val is deprecated.  Use rosky_msgs-msg:rects instead.")
  (rects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SceneSegments>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:Rect))
