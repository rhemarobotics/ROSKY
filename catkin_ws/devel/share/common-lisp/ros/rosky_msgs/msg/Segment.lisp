...
(cl:defclass <Segment> (roslisp-msg-protocol:ros-message)
  ((color
   ...
   :initform (cl:make-array 2 :element-type 'rosky_msgs-msg:Vector2D :initial-element (cl:make-instance 'rosky_msgs-msg:Vector2D)))
   (normal
    :reader normal
    :initarg :normal
...
(cl:defmethod cl:initialize-instance :after ((m <Segment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Segment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<Segment> is deprecated: use rosky_msgs-msg:Segment instead.")))
...
(cl:defmethod normal-val ((m <Segment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:normal-val is deprecated.  Use rosky_msgs-msg:normal instead.")
  (normal m))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Segment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:points-val is deprecated.  Use rosky_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Segment>)))
  ...
  (cl:format cl:nil "uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 color~%rosky_msgs/Vector2D[2] pixels_normalized~%rosky_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: rosky_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Segment)))
  "Returns full string definition for message of type 'Segment"
  (cl:format cl:nil "uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 color~%rosky_msgs/Vector2D[2] pixels_normalized~%rosky_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: rosky_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
