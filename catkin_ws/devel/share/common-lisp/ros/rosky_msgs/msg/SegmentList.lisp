...
(cl:defclass <SegmentList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (segments
    :reader segments
    :initarg :segments
    :type (cl:vector rosky_msgs-msg:Segment)
   :initform (cl:make-array 0 :element-type 'rosky_msgs-msg:Segment :initial-element (cl:make-instance 'rosky_msgs-msg:Segment))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SegmentList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SegmentList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<SegmentList> is deprecated: use rosky_msgs-msg:SegmentList instead.")))
...
(cl:defmethod segments-val ((m <SegmentList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:segments-val is deprecated.  Use rosky_msgs-msg:segments instead.")
  (segments m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SegmentList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosky_msgs-msg:Segment))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SegmentList>)))
  ...
  (cl:format cl:nil "Header header~%rosky_msgs/Segment[] segments~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/Segment~%uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 color~%rosky_msgs/Vector2D[2] pixels_normalized~%rosky_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: rosky_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SegmentList)))
  "Returns full string definition for message of type 'SegmentList"
  (cl:format cl:nil "Header header~%rosky_msgs/Segment[] segments~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rosky_msgs/Segment~%uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 color~%rosky_msgs/Vector2D[2] pixels_normalized~%rosky_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: rosky_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
