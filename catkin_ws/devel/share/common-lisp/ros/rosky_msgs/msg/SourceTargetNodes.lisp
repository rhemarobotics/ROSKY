...
(cl:defmethod cl:initialize-instance :after ((m <SourceTargetNodes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SourceTargetNodes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<SourceTargetNodes> is deprecated: use rosky_msgs-msg:SourceTargetNodes instead.")))

(cl:ensure-generic-function 'source_node-val :lambda-list '(m))
(cl:defmethod source_node-val ((m <SourceTargetNodes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:source_node-val is deprecated.  Use rosky_msgs-msg:source_node instead.")
  (source_node m))

(cl:ensure-generic-function 'target_node-val :lambda-list '(m))
(cl:defmethod target_node-val ((m <SourceTargetNodes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:target_node-val is deprecated.  Use rosky_msgs-msg:target_node instead.")
  (target_node m))
