...
(cl:defmethod cl:initialize-instance :after ((m <ThetaDotSample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ThetaDotSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<ThetaDotSample> is deprecated: use rosky_msgs-msg:ThetaDotSample instead.")))
