...
(cl:defmethod cl:initialize-instance :after ((m <Twist2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<Twist2DStamped> is deprecated: use rosky_msgs-msg:Twist2DStamped instead.")))
...
(cl:defmethod omega-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:omega-val is deprecated.  Use rosky_msgs-msg:omega instead.")
  (omega m))
