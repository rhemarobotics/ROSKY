...
(cl:defmethod cl:initialize-instance :after ((m <WheelsCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelsCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<WheelsCmd> is deprecated: use rosky_msgs-msg:WheelsCmd instead.")))
