...
(cl:defmethod cl:initialize-instance :after ((m <WheelsCmdStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelsCmdStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-msg:<WheelsCmdStamped> is deprecated: use rosky_msgs-msg:WheelsCmdStamped instead.")))
...
(cl:defmethod vel_left-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:vel_left-val is deprecated.  Use rosky_msgs-msg:vel_left instead.")
  (vel_left m))

(cl:ensure-generic-function 'vel_right-val :lambda-list '(m))
(cl:defmethod vel_right-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-msg:vel_right-val is deprecated.  Use rosky_msgs-msg:vel_right instead.")
  (vel_right m))
