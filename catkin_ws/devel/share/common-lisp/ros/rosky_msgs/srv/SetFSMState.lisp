...
(cl:defmethod cl:initialize-instance :after ((m <SetFSMState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFSMState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-srv:<SetFSMState-request> is deprecated: use rosky_msgs-srv:SetFSMState-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetFSMState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-srv:state-val is deprecated.  Use rosky_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetFSMState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFSMState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-srv:<SetFSMState-response> is deprecated: use rosky_msgs-srv:SetFSMState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFSMState-response>)))
  ...
  "rosky_msgs/SetFSMStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFSMState-response)))
  "Returns string type for a service object of type 'SetFSMState-response"
  "rosky_msgs/SetFSMStateResponse")
