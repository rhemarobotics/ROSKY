...
(cl:defmethod cl:initialize-instance :after ((m <SetValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-srv:<SetValue-request> is deprecated: use rosky_msgs-srv:SetValue-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosky_msgs-srv:value-val is deprecated.  Use rosky_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosky_msgs-srv:<SetValue-response> is deprecated: use rosky_msgs-srv:SetValue-response instead.")))
